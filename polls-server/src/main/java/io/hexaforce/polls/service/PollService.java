package io.hexaforce.polls.service;
...
import io.hexaforce.polls.exception.BadRequestException;
import io.hexaforce.polls.exception.ResourceNotFoundException;
import io.hexaforce.polls.model.Choice;
import io.hexaforce.polls.model.ChoiceVoteCount;
import io.hexaforce.polls.model.Poll;
import io.hexaforce.polls.model.User;
import io.hexaforce.polls.model.Vote;
...
import io.hexaforce.polls.util.ModelMapper;
...
public class PollService {
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        Choice selectedChoice = poll.getChoices().stream().filter(choice -> choice.getId().equals(voteRequest.getChoiceId())).findFirst().orElseThrow(() -> new ResourceNotFoundException("Choice", "id", voteRequest.getChoiceId()));
